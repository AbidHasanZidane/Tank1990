...
struct qt_meta_stringdata_CLASSChooseModelSceneENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSChooseModelSceneENDCLASS = QtMocHelpers::stringData(
    "ChooseModelScene",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSChooseModelSceneENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ChooseModelScene::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSChooseModelSceneENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSChooseModelSceneENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSChooseModelSceneENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void ChooseModelScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ChooseModelScene::*)();
            if (_t _q_method = &ChooseModelScene::chooseModelSceneBack; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *ChooseModelScene::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSChooseModelSceneENDCLASS.stringdata0))
