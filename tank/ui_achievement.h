...
public:
    ...
    void setupUi(QWidget *achievement)
    {
        ...
        achievement->setWindowIcon(icon);
    ...
    {
        achievement->setWindowTitle(QCoreApplication::translate("achievement", "\345\235\246\345\205\213\345\244\247\346\210\230 by TANK MAKERS", nullptr));
